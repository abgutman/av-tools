...
.nav a {{ font-size: 14px; font-weight: 600; color: #1b3a4b; text-decoration: none; padding: 6px 16px; border-radius: 6px; }}
.nav a:hover {{ background: #ddd; }}
.nav a.current {{ background: #1b3a4b; color: white; }}
...
<div class="header">
    ...
    <div class="meta">Montgomery County Court of Common Pleas | Updated {now.strftime("%B %d, %Y at %I:%M %p")}</div>
</div>

<div class="nav">
    <a href="montco_lm_dashboard.html" class="current">Lower Merion</a>
    <a href="delco_media_dashboard.html">Greater Media</a>
</div>

<div class="blurb">
    <strong>What this shows:</strong> All civil cases filed in Montgomery County Court of Common Pleas in the past {LOOKBACK_DAYS} days where at least one party has an address in a Lower Merion Township zip code (Ardmore, Bala Cynwyd, Bryn Mawr, Gladwyne, Haverford, Merion Station, Narberth, Havertown, Villanova, Wynnewood). Liens are excluded. Cases appear here for {LOOKBACK_DAYS} days from their filing date, then drop off. Data is refreshed daily at 5 AM.
</div>
